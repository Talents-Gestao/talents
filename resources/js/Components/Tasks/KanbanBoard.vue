    ...
    <div class="space-y-3">
        <div class="flex items-start gap-3 overflow-x-auto pb-3">
            <div
                ...
                class="flex w-72 shrink-0 flex-col rounded-xl bg-slate-100/80 p-2 shadow-sm ring-1 ring-slate-200"
            >
                ...
                >
                    <div
                        ...
                        class="group cursor-pointer rounded-lg bg-white px-3 py-2 text-left shadow-sm ring-1 ring-slate-200 transition hover:ring-talents-300"
                        @click="openCard(card)"
                    >
            ...
            <div v-if="isAdmin" class="w-72 shrink-0">
                <div v-if="showNewListInput" class="space-y-2 rounded-xl bg-slate-100/80 p-2 shadow-sm ring-1 ring-slate-200">
                    <TextInput
                        v-model="newListName"
                ...
                <button
                    v-else
                    type="button"
                    class="flex w-full items-center gap-2 rounded-xl bg-slate-100/70 px-3 py-2 text-sm font-medium text-slate-600 ring-1 ring-slate-200 transition hover:bg-slate-100 hover:text-slate-800"
