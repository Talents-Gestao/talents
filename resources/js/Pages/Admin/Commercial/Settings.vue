        ...
        <form class="mt-6 space-y-6" @submit.prevent="submit">
            ...
            <template v-if="tab === 'vendedores'">
                <section class="surface-card p-6">
                    ...
                    <p class="mt-1 text-xs text-slate-500">
                        Com ou sem comissão e a porcentagem fixa são definidos em
                        Configuração → Equipe (detalhe do administrador).
                        Este valor padrão só serve de referência legada (ex.: migração inicial).
                        Não aparece no PDF enviado ao cliente.
                    </p>
