    ...
    <AdminLayout>
        <template #header>
            <FormPageHeader
                ...
                subtitle="Cadastro avulso sem proposta comercial"
            />
        </template>
        ...
        <form class="surface-card mx-auto max-w-2xl space-y-4 p-6" @submit.prevent="submit">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    <InputLabel for="commission_percent" value="Comissão (%)" />
                    <TextInput
                        ...
                        class="mt-1 block w-full"
                    />
                    <InputError class="mt-1" :message="form.errors.commission_percent" />
                </div>
            </div>
            ...
            <div>
                ...
                <TextInput id="first_due_date" v-model="form.first_due_date" type="date" class="mt-1 block w-full" required />
