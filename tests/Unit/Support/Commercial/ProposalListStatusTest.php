...
class ProposalListStatusTest extends TestCase
{
    ...
    public function test_open_when_sale_aberta(): void
    {
        $proposal = $this->makeProposal(isClosed: false);
    ...
    public function test_in_progress_when_sale_parcial(): void
    {
        $proposal = $this->makeProposal(isClosed: false);
    ...
    public function test_in_progress_prevails_when_is_closed_and_parcial(): void
    {
        $proposal = $this->makeProposal(isClosed: true);
        $this->attachSale($proposal, CommercialSale::STATUS_PARCIAL);
    ...
    public function test_closed_when_sale_quitada_even_if_not_is_closed(): void
    {
        $proposal = $this->makeProposal(isClosed: false);
    ...
    public function test_closed_when_is_closed_and_sale_aberta(): void
    {
        $proposal = $this->makeProposal(isClosed: true);
        $this->attachSale($proposal, CommercialSale::STATUS_ABERTA);
    ...
    public function test_open_when_sale_cancelada_and_not_closed(): void
    {
        $proposal = $this->makeProposal(isClosed: false);
        $this->attachSale($proposal, CommercialSale::STATUS_CANCELADA);
    ...
    private function makeProposal(bool $isClosed): CommercialProposal
    {
        return CommercialProposal::create([
