...
class SaleController extends Controller
{
    ...
    public function edit(CommercialSale $sale): Response
    {
        ...
        return Inertia::render('Admin/Finance/Sales/Form', [
            ...
            'sale' => [
                ...
                'proposal_code' => $sale->proposal?->code,
                'client_name' => $sale->client_name,
                'client_cnpj' => $sale->client_cnpj,
    ...
    public function update(Request $request, CommercialSale $sale): RedirectResponse
    {
        $data = $request->validate([
            ...
            'sold_at.required' => 'Informe a data da venda.',
            'client_email.email' => 'Informe um e-mail válido.',
        ]);

        // Edição comercial da venda: não recalcula parcelas/total (evita divergência no ledger).
        $sale->update([
     ...
     * }
     */
    private function saleFormOptions(): array
    {
        return [
            'sellers' => User::query()
                ->where('is_commercial', true)
