...
use App\Services\Offboarding\ExitInterviewPdfService;
...
class ExitInterviewController extends DesligamentoCompanyController
{
    ...
    public function index(Request $request): Response|RedirectResponse
    {
        ...
        if ($context->needsCompanySelection($request)) {
            return Inertia::render('Client/Offboarding/Index', [
    ...
    public function create(Request $request): Response
    {
        ...
        return Inertia::render('Client/Offboarding/Form', [
            'mode' => 'create',
            'interview' => null,
    ...
    public function show(Request $request, ExitInterview $interview): Response
    {
        ...
        return Inertia::render('Client/Offboarding/Show', [
            'interview' => [
                'id' => $interview->id,
                'interview_date' => $interview->interview_date?->toDateString(),
                'status' => $interview->status->value,
