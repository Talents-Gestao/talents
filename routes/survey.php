...
Route::get('/pesquisa/{token}', [PublicSurveyController::class, 'show'])
    ->middleware('throttle:public-token-page')
    ->name('survey.public');
Route::get('/pesquisa/{token}/obrigado', [PublicSurveyController::class, 'thanks'])
    ->middleware('throttle:public-token-page')
    ->name('survey.public.thanks');
